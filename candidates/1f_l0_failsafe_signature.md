...
**What this does NOT change:** [cont 26 §3](../continuations/26.md) L0 evolved failsafes Tier 1 epistemological canon UNCHANGED. The substrate-level claim was never on trial — it's about failsafe DYNAMICS, not about a specific operationalization. Pilot #150 falsified the static-binary operationalization; Pilot 2 falsified the rolling-amplitude operationalization; cont 26 §3 stands independent of which operationalization the framework chose to test. Cont 27 §3 narrow-before-demote applied at the operationalization layer; clean falsifier-firings pruned both operationalizations without touching the underlying substrate claim. *(Per audit v08 §C7 + F6 down-tune 2026-06-05: prior wording "the discipline-cycle worked exactly as cont 27 §3 promises" was over-confident closure register. The narrower factual claim above survives; the celebratory register doesn't.)*
