...
**This is a candidate for the framework's /speculations/ mode-page as a third Tier 3 entry** alongside the aux-channel L0-occlusion entry and the cont 17 latent-substrate Wheeler-style entry. Will be added there with the promotion bars named.
...
**10.2 New Tier 3 speculative entry** — "Cultural eigenmode analysis via RC-Koopman hybrid" — added to /speculations/ as third entry alongside aux-channel L0-occlusion and cont 17 latent-substrate-Wheeler. Three promotion bars named per cont 27 §3.
